...
# --------------------
# YouTube Cookie Login Configuration (NEW)
# --------------------
YOUTUBE_EMAIL = os.environ.get("YOUTUBE_EMAIL", "pm5763468@gmail.com")
YOUTUBE_PASSWORD = os.environ.get("Pubjmobilemerehe13nhi", "your_app_password")  # Use App Password if 2FA enabled
COOKIES_FILE = os.environ.get("COOKIES_FILE", "cookies.json")
REFRESH_INTERVAL = int(os.environ.get("REFRESH_INTERVAL", 12 * 60 * 60))  # Default: 12 hours
